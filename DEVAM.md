...
- clerk-js: jsDelivr `@clerk/clerk-js@6.15.1`. `@clerk/react` 6.15 `clerkJSUrl` yok sayar; `__internal_clerkJSUrl` gerekir. Ayrı `@clerk/ui` yükleme (Google/Microsoft ikonlarını zorluyordu)
- SW: `aog-shell-v6` (`/__clerk`, `/api/`, `/v1/` bypass)
