...
- clerk-js: jsDelivr `@clerk/clerk-js@6`. `@clerk/react` 6.15 `clerkJSUrl` yok sayar; `__internal_clerkJSUrl` gerekir. Ayrı `@clerk/ui` yok (Google/Microsoft ikonlarını zorluyordu)
